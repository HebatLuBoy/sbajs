...
class Talk(object):
    ...
    @loggedIn
    def BecauseMyTeAmPEOPLEBOT(self, to, text, contentMetadata={}, contentType=0):
        msg = Message()
    ...
    def sendVideo(self, to, path):
        objectId = self.BecauseMyTeAmPEOPLEBOT(to=to, text=None, contentMetadata={'VIDLEN': '60000','DURATION': '60000','PREVIEW_URL': 'http://dl.profile.line-cdn.net/{}'.format(self.getProfile().pictureStatus)}, contentType = 2).id
    ...
    def sendAudio(self, to, path):
        objectId = self.BecauseMyTeAmPEOPLEBOT(to=to, text=None, contentType = 3).id
    ...
    @loggedIn
    def TendanganMautiniBOSS(self, groupId, midlist):
